...
LibroCalificaciones::LibroCalificaciones( string nombre, string nombrei ): nombreCurso( nombre ), nombreInstructor(nombrei) // inicializador de miembro para inicializar nombreCurso
{
    // cuerpo vacío
